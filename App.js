...
import { 
  Alert, Text, View, Linking, TouchableHighlight, PermissionsAndroid,PermissionAwareActivity, 
    ...
    if (!this.state.opneScanner) {
      return (
        <View style={styles.container2}>
            <Text style={styles.heading}>React Native Face Detect & QR Code Example</Text>
